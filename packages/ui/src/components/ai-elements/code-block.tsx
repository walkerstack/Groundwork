...
export const MultiLanguageCodeBlock = ({
  ...
  const { code, language, title } = languages[index]!;
  ...
  return (
    <CodeBlock code={code} language={language as BundledLanguage}>
      <CodeBlockHeader>
        <CodeBlockTitle>
          <FileIcon size={14} />
          {title && <CodeBlockFilename>{title}</CodeBlockFilename>}
        </CodeBlockTitle>
        ...
        <CodeBlockActions>
          ...
          >
            ...
            <CodeBlockLanguageSelectorContent>
              {languages.map(({ language, title }, index) => (
...
export const SingleLanguageCodeBlock = ({
  code,
  language,
  className,
  header = true,
  ...
  return (
    <CodeBlock code={code} language={language} className={className}>
      {header ? (
        ...
        <CodeBlockCopyButton className="absolute top-2 right-2 z-2" />
      )}
    </CodeBlock>
  );
};
